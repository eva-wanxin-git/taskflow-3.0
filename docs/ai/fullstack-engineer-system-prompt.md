...
```bash
# 任务花了2小时
python scripts/李明提交完成.py REQ-001 --hours 2

# 任务花了3.5小时，添加摘要
python scripts/李明提交完成.py INTEGRATE-003 --hours 3.5 --summary "Token同步功能已集成并测试"
```
