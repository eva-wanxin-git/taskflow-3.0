...
class ProjectMemoryService:
    ...
    def _store_to_ultra_memory(
        ...
        try:
            ...
            url = "http://13.158.83.99:7000/store"
            
            # 准备请求数据
            payload = {
                "userId": project_id,  # 使用项目代码作为userId
                "content": content,
                "metadata": {
                    **metadata,
    ...
    def _store_to_session_memory(
        ...
        使用session-memory-mcp创建会话记忆
        """
        try:
            import httpx
            
            # Session Memory MCP URL
            url = "http://13.158.83.99:4000/memory/store"
    ...
    def _query_from_ultra_memory(
        ...
        try:
            ...
            # Ultra Memory MCP URL
            url = "http://13.158.83.99:7000/search"
